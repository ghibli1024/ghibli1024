...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ghibli1024', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || ' Have a good day', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ghibli1024.com', // 网站地址
